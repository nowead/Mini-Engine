...
inline WGPUTextureDimension ToWGPUTextureDimension(rhi::TextureDimension dimension) {
    switch (dimension) {
...
inline WGPUTextureViewDimension ToWGPUTextureViewDimension(rhi::TextureViewDimension dimension) {
    switch (dimension) {
...
inline WGPUCompareFunction ToWGPUCompareFunc(rhi::CompareOp op) {
    switch (op) {
