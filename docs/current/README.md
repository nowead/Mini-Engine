...
단계: ~~D1 RHI 스레드 안전 커맨드 풀~~ ✅ → ~~D2 스레드 풀~~ ✅ → ~~D3 병렬 패스 기록
(셰도우 4 캐스케이드)~~ ✅ → **D4 CPU 프레임 시간 측정**. 상세: [ENGINE_ROADMAP §D](engine-roadmap/ENGINE_ROADMAP.md).
...
(D2 스레드 풀 · D3-0a/0b 장애물 해소 · D3-1/2 셰도우 캐스케이드 병렬 기록) ·
